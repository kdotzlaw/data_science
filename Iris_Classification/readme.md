...
After reading the training report and testing, we can see that logistic regression scores highly in all areas, even without tuning.
...
After reading the training report and testing, we can see that the decision tree scores above 0.90 in almost all areas, even without tuning.
